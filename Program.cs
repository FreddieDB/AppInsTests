	...
	class Program
    {
        static void Main(string[] args)
        {
           ...
           //configuration.TelemetryInitializers.Add(new OperationCorrelationTelemetryInitializer());
            ...
            telemetryClient.Context.User.Id = "debeerf1@test7789.enbridge.com";
            telemetryClient.Context.Cloud.RoleName = "OrionHub UWP App FdBTests";
            ...
            // Event Tel
            EventTelemetry et = new EventTelemetry("FdB.AppInsights.UnitTest.CADUpload v202W3COff");
            et.Properties.Add("SiteId", "FDY");
            et.Properties.Add("PFDVersion", "FDBTest111");
